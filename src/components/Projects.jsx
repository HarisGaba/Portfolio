...
const categories = [
  ...
  },
  {
    ...
    projects: [
      {
        title: 'Pen & Paper — Website',
        url: 'https://penandpaper.freehosting.dev/index.php',
        img: '/assets/pen-paper-website.jpg',
        desc: 'Full e-commerce storefront for a premium stationery and office supplies brand — featuring category browsing, featured products, customer reviews, and a complete checkout flow.',
        tags: ['PHP', 'Laravel', 'MySQL', 'E-Commerce'],
      },
      {
        title: 'Pen & Paper — Admin Panel',
        url: 'https://penandpaper.freehosting.dev/index.php',
        img: '/assets/pen-paper-admin.jpg',
        desc: 'Custom admin dashboard for Pen & Paper with user management, order tracking, product CRUD, categories, employees, and reviews — all connected to a MySQL database.',
        tags: ['PHP', 'Laravel', 'MySQL', 'Admin Panel'],
      },
      {
        title: 'More PHP Projects',
        url: '#',
        img: null,
